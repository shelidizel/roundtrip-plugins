<?php
   add_filter( 'elementor/icons_manager/additional_tabs', 'gowilds_custom_icons_filters' , 9999999, 1 );
   function gowilds_custom_icons_filters( $tabs = array() ) {
      $newicons = [
         "gwflaticon-helmet",
         "gwflaticon-best-price",
         "gwflaticon-travel",
         "gwflaticon-right-quote",
         "gwflaticon-flight",
         "gwflaticon-camp",
         "gwflaticon-blanket",
         "gwflaticon-cat",
         ...
         "gwflaticon-fire",
         "gwflaticon-rabbit",
         "gwflaticon-wifi-router",
         "gwflaticon-solar-energy",
         "gwflaticon-cycling",
         "gwflaticon-fishing",
         "gwflaticon-gym",
         "gwflaticon-hiking",
         ...
         "gwflaticon-quote",
         "gwflaticon-camping",
         "gwflaticon-cable-car",
         "gwflaticon-trailer",
         "gwflaticon-firewood",
         "gwflaticon-biking-mountain",
         "gwflaticon-fishing-1",
         "gwflaticon-fishing-2",
         "gwflaticon-caravan",
         "gwflaticon-world",
         "gwflaticon-journey",
                  "flaticon-selection",
      ...
      $icons['gva_custom_icon'] = array(
           'name'          => 'gowilds-icons-theme',
           'label'         => esc_html__( 'Icons Theme', 'gowilds-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $newicons,
           'url'          => GAVIAS_GOWILDS_PLUGIN_URL . 'assets/icons/style.css',
           'ver'           => '1.0',
       );
   ...
   add_action( 'wp_print_footer_scripts', 'gowilds_insert_icons_footer_css'  );
   function gowilds_insert_icons_footer_css() {
      echo '<link rel="stylesheet" type="text/css" href="' . GAVIAS_GOWILDS_PLUGIN_URL . 'assets/icons/style.css">';
   }

   add_filter( 'elementor/icons_manager/additional_tabs', 'gowilds_lineawesome_icon' );  
   function gowilds_lineawesome_icon( $icons = array() ) {
       ...
       $icons['gowilds-lineawesome-icon'] = array(
           'name'          => 'gowilds-icons-lineawesome',
           'label'         => esc_html__( 'Line Awesome', 'gowilds-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_GOWILDS_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
