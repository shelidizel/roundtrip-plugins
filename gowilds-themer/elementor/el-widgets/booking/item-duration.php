...
class GVAElement_BA_Item_Duration extends GVAElement_Base{
   ...
   public function get_title() {
      return __('BA Item Duration', 'gowilds-themer');
   }
   ...
   protected function register_controls() {
      ...
      $this->add_control(
         ...
         [
            ...
            'default'      => esc_html__( 'Duration', 'gowilds-themer' ),
            'label_block'  => true
         ]
      );
      ...
      $this->add_group_control(
         ...
         [
            ...
            'selector' => '{{WRAPPER}} .gowilds-single-duration .ba-meta-title',
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
               '{{WRAPPER}} .gowilds-single-duration .item-value' => 'color: {{VALUE}};',
            ],
         ]
      );
      ...
      $this->add_group_control(
         ...
         [
            ...
            'selector' => '{{WRAPPER}} .gowilds-single-duration .item-value',
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
               '{{WRAPPER}} .gowilds-single-duration .icon i' => 'color: {{VALUE}};',
               '{{WRAPPER}} .gowilds-single-duration .icon svg' => 'fill: {{VALUE}};',
            ],
         ]
      );
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
              '{{WRAPPER}} .gowilds-single-duration .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
              '{{WRAPPER}} .gowilds-single-duration .icon svg' => 'width: {{SIZE}}{{UNIT}};'
            ],
         ]
      );
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
              '{{WRAPPER}} .gowilds-single-duration .icon' => 'padding-right: {{SIZE}}{{UNIT}};',
            ],
         ]
      );
