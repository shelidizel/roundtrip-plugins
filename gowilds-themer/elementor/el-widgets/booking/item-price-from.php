...
class GVAElement_BA_Price_From extends GVAElement_Base{
   ...
   public function get_title() {
      return __('BA Item Price From', 'gowilds-themer');
   }
   ...
   protected function register_controls() {
      ...
      $this->add_control(
         ...
         [
            ...
            'default'      => esc_html__( 'From', 'gowilds-themer' ),
            'label_block'  => true
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'selectors' => [
               '{{WRAPPER}} .gowilds-single-price_from .ba-meta-title' => 'color: {{VALUE}};',
            ],
         ]
      );
      ...
      $this->add_group_control(
         ...
         [
            ...
            'selector' => '{{WRAPPER}} .gowilds-single-price_from .ba-meta-title',
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
               '{{WRAPPER}} .gowilds-single-price_from .item-value' => 'color: {{VALUE}};',
            ],
         ]
      );
      ...
      $this->add_group_control(
         ...
         [
            ...
            'selector' => '{{WRAPPER}} .gowilds-single-price_from .item-value',
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
               '{{WRAPPER}} .gowilds-single-price_from .icon i' => 'color: {{VALUE}};',
               '{{WRAPPER}} .gowilds-single-price_from .icon svg' => 'fill: {{VALUE}};',
            ],
         ]
      );
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
              '{{WRAPPER}} .gowilds-single-price_from .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
              '{{WRAPPER}} .gowilds-single-price_from .icon svg' => 'width: {{SIZE}}{{UNIT}};'
            ],
         ]
      );
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
              '{{WRAPPER}} .gowilds-single-price_from .icon' => 'padding-right: {{SIZE}}{{UNIT}};',
            ],
         ]
      );
