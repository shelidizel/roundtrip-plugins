...
*/
class Gowilds_Addons_Change_User_Info_Ajax{
   ...
   public function ajax_auth_init(){ 
      add_action( 'wp_ajax_nopriv_gowilds_change_user_info', array($this, 'ajax_change') );
      add_action( 'wp_ajax_gowilds_change_user_info', array($this, 'ajax_change') );
   }
   ...
   public function ajax_change(){
      ...
      echo json_encode(array(
         'message'=> '<div class="alert alert-success">' . esc_html__('Your Profile has been successfully changed.', 'gowilds-themer') . '</div>'
      ));
      exit;
   }
...
new Gowilds_Addons_Change_User_Info_Ajax();