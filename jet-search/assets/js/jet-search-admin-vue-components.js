...
Vue.component('jet-search-suggestions-config', {
	...
	methods: {
		updateUseSessionDesc: function() {
			this.generalSettingsLabels.use_session.desc = 'If this option is enabled, the plugin will save only ' + this.currentLimits + ' suggestions from a single user. If disabled, all requests will be saved. This option will help to avoid suggestion spam.';
		},
		showPopUp: function() {
